...
hardware. Future TGs may address other standards for infrastructure
and tooling, such as CX packages, debug, profile, formal specification
of CX interface contracts, and CX library metadata.
